#ifndef igwCloudMapRepresentationWidget_H
#define igwCloudMapRepresentationWidget_H
...
namespace Ui {
class igwCloudMapRepresentationWidget;
}

class igwCloudMapRepresentationWidget : public QDialog
{
    Q_OBJECT

public:
    explicit igwCloudMapRepresentationWidget(QWidget *parent = nullptr);
    ~igwCloudMapRepresentationWidget();
