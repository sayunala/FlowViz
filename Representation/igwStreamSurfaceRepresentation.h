#ifndef igwStreamSurfaceRepresentation_H
#define igwStreamSurfaceRepresentation_H
...
class igwStreamSurfaceRepresentation : public igwRenderedRepresentation
{
public:
    vtkTypeMacro(igwStreamSurfaceRepresentation, igwRenderedRepresentation);
    static igwStreamSurfaceRepresentation* New();
...
protected:
    igwStreamSurfaceRepresentation();
    ~igwStreamSurfaceRepresentation();
...
private:
    igwStreamSurfaceRepresentation(const igwStreamSurfaceRepresentation&) = delete;
    void operator =(const igwStreamSurfaceRepresentation&) = delete;
};

#endif // igwStreamSurfaceRepresentation_H
