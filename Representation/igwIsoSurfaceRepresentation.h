#ifndef IGWISOSURFACEREPRESENTATION_H
#define IGWISOSURFACEREPRESENTATION_H
...
class igwIsoSurfaceRepresentation : public igwRenderedRepresentation
{
public:
    static igwIsoSurfaceRepresentation* New();
    vtkTypeMacro(igwIsoSurfaceRepresentation, igwRenderedRepresentation);
    ...
    void SetNumberOfContoursApi(int num);
    int GetNumberOfContoursApi(){
    ...
    /**
     * @brief GenerateValues: 生成等值面
     * @param numberOfContours: 生成的等值面数量
     */
    void GenerateValues(int numberOfContours, double []);
    /**
...
protected:
    igwIsoSurfaceRepresentation();
    ~igwIsoSurfaceRepresentation() override;
    ...
    /**
     * @brief Set or Get the Number of Contours.
     * @brief 设置或获取需要生成等值面的数量。
     */
    vtkSetMacro(NumberOfContours, int);
    vtkGetMacro(NumberOfContours, int);
    int NumberOfContours;// 等值面的数量



private:
    igwIsoSurfaceRepresentation(const igwIsoSurfaceRepresentation&) = delete;
    void operator =(const igwIsoSurfaceRepresentation&) = delete;
};

#endif // IGWISOSURFACEREPRESENTATION_H
