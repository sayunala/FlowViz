...
* @file          igwCloudMapRepresentation.h
...
#ifndef IGWCLOUDMAPREPRESENTATION_H
#define IGWCLOUDMAPREPRESENTATION_H
...
class igwCloudMapRepresentation : public igwRenderedRepresentation
{
public:
    vtkTypeMacro(igwCloudMapRepresentation, igwRenderedRepresentation);
    static igwCloudMapRepresentation* New();
    ...
    /**
     * @brief SetDataType: 设置数据类型是3D或2D
     * @param type
     */
...
private:
    igwCloudMapRepresentation(const igwCloudMapRepresentation&) = delete;
    void operator =(const igwCloudMapRepresentation&) = delete;
};

#endif // IGWCLOUDMAPREPRESENTATION_H
