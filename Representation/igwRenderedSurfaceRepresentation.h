#ifndef IGWRENDEREDSURFACEREPRESENTATION_H
#define IGWRENDEREDSURFACEREPRESENTATION_H

#include "igwRenderedRepresentation.h"
#include "vtkDataSetSurfaceFilter.h"
#include "Externsions/Sources/vtkPVGeometryFilter.h"
#include "vtkCompositeDataGeometryFilter.h"
class vtkPolyDataMapper;
class vtkGeometryFilter;
class vtkApplyColors;
class vtkUnstructuredGridGeometryFilter;
class igwRenderedSurfaceRepresentation : public igwRenderedRepresentation
{
public:
    static igwRenderedSurfaceRepresentation* New();
    vtkTypeMacro(igwRenderedSurfaceRepresentation, igwRenderedRepresentation)
...
protected:
    igwRenderedSurfaceRepresentation();
    ~igwRenderedSurfaceRepresentation();
    /**
    ...
    */
    ...
    vtkCompositeDataGeometryFilter* CompositeDataGeometryFilter;
    vtkGeometryFilter* GeometryFilter;
    vtkDataSetSurfaceFilter* ExtractSurface;

    vtkApplyColors* ApplyColors;


private:
    igwRenderedSurfaceRepresentation(const igwRenderedSurfaceRepresentation&) = delete;
    void operator =(const igwRenderedSurfaceRepresentation&) = delete;
};

#endif // IGWRENDEREDSURFACEREPRESENTATION_H
