...
#define XR_MSFT_holographic_remoting_SPEC_VERSION   6
#define XR_MSFT_HOLOGRAPHIC_REMOTING_EXTENSION_NAME "XR_MSFT_holographic_remoting"
    ...
    typedef enum XrRemotingStructureType
    {
        ...
        XR_TYPE_EVENT_DATA_REMOTING_TIMESTAMP_CONVERSION_READY_MSFT = 1000065022,
        XR_TYPE_REMOTING_AUDIO_OUTPUT_CAPTURE_SETTINGS_MSFT = 1000065023,
        XR_TYPE_REMOTING_PREFERRED_GRAPHICS_ADAPTER_MSFT = 1000065024,
    ...
    typedef enum XrRemotingResult
    {
        ...
        XR_ERROR_REMOTING_TIMESTAMP_CONVERSION_NOT_READY_MSFT = -100006510,
        XR_ERROR_REMOTING_AUDIO_OUTPUT_NOT_ENABLED_MSFT = -100006511,
    ...
    typedef enum XrRemotingAudioOutputCaptureModeMSFT
    {
        XR_REMOTING_AUDIO_OUTPUT_CAPTURE_MODE_SYSTEM_WIDE_MSFT = 0,
        XR_REMOTING_AUDIO_OUTPUT_CAPTURE_MODE_APP_ONLY_MSFT = 1
    } XrRemotingAudioOutputCaptureModeMSFT;
    ...
    typedef struct XrEventDataRemotingTimestampConversionReadyMSFT
    {
        XrStructureType type;
        const void* next;
    } XrEventDataRemotingTimestampConversionReadyMSFT;

    typedef struct XrRemotingAudioOutputCaptureSettingsMSFT
    {
        XrStructureType type;
        const void* next;
        XrRemotingAudioOutputCaptureModeMSFT audioOutputCaptureMode;
    } XrRemotingAudioOutputCaptureSettingsMSFT;
    ...
    // Chain to XrGraphicsRequirementsD3D[11/12]KHR in xrGetD3D[11/12]GraphicsRequirementsKHR to request the use of a graphics adapter
    typedef struct XrRemotingPreferredGraphicsAdapterMSFT
    {
        XrStructureType type;
        void* next;
        LUID adapterLuid;
    ...
    typedef XrResult(XRAPI_PTR* PFN_xrRetrieveRemotingDataMSFT)(
        ...
        uint8_t* data);
    typedef XrResult(XRAPI_PTR* PFN_xrConvertTimestampPlayerToRemoteMSFT)(
        XrSession session, int64_t playerTicksSinceEpoch, int64_t* remoteTicksSinceEpoch);
    typedef XrResult(XRAPI_PTR* PFN_xrConvertTimestampRemoteToPlayerMSFT)(
        XrSession session, int64_t remoteTicksSinceEpoch, int64_t* playerTicksSinceEpoch);
...
#    ifdef XR_EXTENSION_PROTOTYPES
    ...
    XRAPI_ATTR XrResult XRAPI_CALL
        xrConvertTimestampPlayerToRemoteMSFT(XrSession session, int64_t playerTicksSinceEpoch, int64_t* remoteTicksSinceEpoch);
    XRAPI_ATTR XrResult XRAPI_CALL
        xrConvertTimestampRemoteToPlayerMSFT(XrSession session, int64_t remoteTicksSinceEpoch, int64_t* playerTicksSinceEpoch);
