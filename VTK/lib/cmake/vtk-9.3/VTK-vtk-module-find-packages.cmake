...
set(_vtk_module_find_package_fail_if_not_found OFF)
if (_vtk_module_find_package_components)
  if ("RenderingOpenXRRemoting" IN_LIST _vtk_module_find_package_components)
    set(_vtk_module_find_package_enabled ON)
    if ("RenderingOpenXRRemoting" IN_LIST _vtk_module_find_package_components_required)
      set(_vtk_module_find_package_is_required "${${CMAKE_FIND_PACKAGE_NAME}_FIND_REQUIRED}")
      set(_vtk_module_find_package_fail_if_not_found ON)
    endif ()
  endif ()
...
if (_vtk_module_find_package_enabled)
  ...
  find_package(OpenXRRemoting
    ...
    COMPONENTS          
    OPTIONAL_COMPONENTS )
  if (NOT OpenXRRemoting_FOUND AND _vtk_module_find_package_fail_if_not_found)
    if (NOT ${CMAKE_FIND_PACKAGE_NAME}_FIND_QUIETLY)
      message(STATUS
        "Could not find the ${CMAKE_FIND_PACKAGE_NAME} package due to a "
        "missing dependency: OpenXRRemoting")
    endif ()
    set("${CMAKE_FIND_PACKAGE_NAME}_RenderingOpenXRRemoting_FOUND" 0)
    list(APPEND "${CMAKE_FIND_PACKAGE_NAME}_RenderingOpenXRRemoting_NOT_FOUND_MESSAGE"
      "Failed to find the OpenXRRemoting package.")
  endif ()
endif ()
