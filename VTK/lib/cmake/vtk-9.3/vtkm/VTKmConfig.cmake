...
set(VTKm_VERSION_MINOR "0")
set(VTKm_VERSION_PATCH "0")
set(VTKm_VERSION_FULL "2.0.0")
set(VTKm_VERSION "2.0")
...
if(CMAKE_CURRENT_LIST_DIR STREQUAL "D:/BaiduNetdiskDownload/VTK-9.3.0/build/lib/cmake/vtk-9.3/vtkm")
  set(VTKm_PACKAGE_IN_BUILD TRUE)
endif()

if(VTKm_PACKAGE_IN_BUILD)
  set_and_check(VTKm_CMAKE_MODULE_PATH "D:/BaiduNetdiskDownload/VTK-9.3.0/ThirdParty/vtkm/vtkvtkm/vtk-m/CMake")
else()
  set_and_check(VTKm_CMAKE_MODULE_PATH "${PACKAGE_PREFIX_DIR}/lib/cmake/vtk-9.3/vtkm/cmake")
endif()
...
set_and_check(VTKm_CONFIG_DIR "${PACKAGE_PREFIX_DIR}/lib/cmake/vtk-9.3/vtkm")
set(VTKM_FROM_INSTALL_DIR FALSE)
if(NOT "${CMAKE_BINARY_DIR}" STREQUAL "D:/BaiduNetdiskDownload/VTK-9.3.0/build/ThirdParty/vtkm/vtkvtkm/vtk-m")
