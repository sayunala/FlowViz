...
//-----------------------------------------------------------------------------
class igwHierarchicalGridWidget::pqInternals
{
  int Active = -1;
  int MouseOffset = 0;
...
public:
  ...
  std::vector<std::pair<igwHierarchicalGridWidget::SplitterInfo, QRect>> Splitters;
  ...
  void stop(const QPoint& pos, igwHierarchicalGridWidget* self)
  {
...
//-----------------------------------------------------------------------------
igwHierarchicalGridWidget::igwHierarchicalGridWidget(QWidget* parentObject)
  : Superclass(parentObject)
  , Internals(new igwHierarchicalGridWidget::pqInternals())
{
...
//-----------------------------------------------------------------------------
igwHierarchicalGridWidget::~igwHierarchicalGridWidget() = default;

//-----------------------------------------------------------------------------
void igwHierarchicalGridWidget::setUserResizability(bool val)
{
  auto& internals = (*this->Internals);
...
//-----------------------------------------------------------------------------
bool igwHierarchicalGridWidget::userResizability() const
{
  auto& internals = (*this->Internals);
...
//-----------------------------------------------------------------------------
void igwHierarchicalGridWidget::setSplitters(
  const QVector<igwHierarchicalGridWidget::SplitterInfo>& splitters)
{
  auto& internals = (*this->Internals);
...
//-----------------------------------------------------------------------------
bool igwHierarchicalGridWidget::eventFilter(QObject* caller, QEvent* evt)
{
  auto& internals = (*this->Internals);
...
//-----------------------------------------------------------------------------
void igwHierarchicalGridWidget::mouseMoveEvent(QMouseEvent* evt)
{
...
//-----------------------------------------------------------------------------
void igwHierarchicalGridWidget::mousePressEvent(QMouseEvent* evt)
{
  auto& internals = (*this->Internals);
  if (!internals.UserResizability)
  {
...
//-----------------------------------------------------------------------------
void igwHierarchicalGridWidget::mouseReleaseEvent(QMouseEvent* evt)
{
  auto& internals = (*this->Internals);
...
//-----------------------------------------------------------------------------
void igwHierarchicalGridWidget::setSplitFraction(int location, double fraction)
{
  if (auto l = qobject_cast<igwHierarchicalGridLayout*>(this->layout()))
  {
